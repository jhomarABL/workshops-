"""
This module provides a simple command-line interface (CLI) for customizing arcade machines and selecting video games.

Author: Jhomar Armando Bojaca Landinez <jabojacal@udistrital.edu.co>

This file is part of ArcadeMachine-Customizer.

ArcadeMachine-Customizer is free software: you can redistribute it and/or modify 
...
You should have received a copy of the GNU General Public License along with ArcadeMachine-Customizer. 
...
def main():
    ...
    available_games = [
        ...
        VideoGame(
            "Virtual Reality Dance", "VR Studio", "3D", "VirtualReality", 40, 2021
        ),
        VideoGame("Mario Kart 8 Deluxe", "Nintendo", "Realista", "Racing", 60, 2017),
        VideoGame(
            "Gran Turismo 7", "Polyphony Digital", "Realista", "Racing", 60, 2022
        ),
        VideoGame("Need for Speed Heat", "Ghost Games", "Realista", "Racing", 60, 2019),
        VideoGame(
            "Forza Horizon 5", "Playground Games", "Realista", "Racing", 60, 2021
        ),
        VideoGame(
            "Wipeout Omega Collection", "Sony XDEV", "Realista", "Racing", 40, 2017
        ),
        VideoGame(
            "Overwatch", "Blizzard Entertainment", "Realista", "Shooting", 40, 2016
        ),
        VideoGame(
            "Call of Duty: Warzone", "Infinity Ward", "Realista", "Shooting", 0, 2020
        ),
        VideoGame("DOOM Eternal", "id Software", "Realista", "Shooting", 60, 2020),
        VideoGame("Battlefield V", "DICE", "Realista", "Shooting", 60, 2018),
        VideoGame(
            "Apex Legends", "Respawn Entertainment", "Realista", "Shooting", 0, 2019
        ),
        VideoGame(
            "Counter-Strike: Global Offensive", "Valve", "Realista", "Shooting", 0, 2012
        ),
        ...
        VideoGame(
            "Gran Turismo Sport", "Polyphony Digital", "Realista", "Racing", 60, 2017
        ),
        VideoGame("Trackmania", "Nadeo", "Colorido", "Racing", 30, 2020),
        VideoGame(
            "Super Bomberman R Online", "Konami", "Colorido", "Shooting", 30, 2021
        ),
        VideoGame(
            "Dead by Daylight",
        ...
        VideoGame(
            "Unturned", "Smartly Dressed Games", "Pixel Art", "Shooting", 0, 2014
        ),
        ...
        VideoGame(
            "Escape from Tarkov", "Battlestate Games", "Realista", "Shooting", 0, 2020
        ),
        VideoGame(
            "Ghost Recon Breakpoint", "Ubisoft", "Realista", "Shooting", 60, 2019
        ),
        ...
        if choice == "1":
            ...
            for game in available_games:
                if game.category == machine.get_category():
                    ...
                    print(
                        VideoGame(
                            "Just Dance 2021", "Ubisoft", "Realistic", "Dance", 60, 2020
                        )
                    )
                    print(
                        VideoGame(
                            "Dance Central", "Harmonix", "Realistic", "Dance", 50, 2010
                        )
                    )
                    ...
                    print(
                        VideoGame(
                            "Battlefield V", "DICE", "Realistic", "Shooting", 60, 2018
                        )
                    )
                    print(
                        VideoGame(
                    ...
                    print(
                        VideoGame(
                            "Left 4 Dead 2", "Valve", "Realistic", "Shooting", 20, 2009
                        )
                    )
                    print(
                        VideoGame(
                            "Splatoon 2", "Nintendo", "Colorful", "Shooting", 60, 2017
                        )
                    )
                    print(
                        VideoGame(
                    ...
                    print(
                        VideoGame(
                            "Destiny 2", "Bungie", "Realistic", "Shooting", 0, 2017
                        )
                    )
                    ...
                    print(
                        VideoGame(
                            "Mario Kart Wii", "Nintendo", "Colorful", "Racing", 50, 2008
                        )
                    )
                    print(
                        VideoGame(
                            "F1 2021", "Codemasters", "Realistic", "Racing", 60, 2021
                        )
                    )
                    print(
                        VideoGame(
                            "Dirt 5", "Codemasters", "Realistic", "Racing", 60, 2020
                        )
                    )
                    print(
                        VideoGame(
                            "Rocket League", "Psyonix", "Realistic", "Racing", 20, 2015
                        )
                    )
                    print(
                        VideoGame(
                    ...
                    print(
                        VideoGame("Trackmania", "Nadeo", "Colorful", "Racing", 30, 2020)
                    )
                    ...
                    print(
                        VideoGame(
                            "Trials Rising", "RedLynx", "Realistic", "Racing", 40, 2019
                        )
                    )
                    print(
                        VideoGame(
                    ...
                    print(
                        VideoGame(
                            "Valorant", "Riot Games", "Realistic", "Shooting", 0, 2020
                        )
                    )
                    ...
                    print(
                        VideoGame(
                            "Space Invaders", "Taito", "Pixel Art", "Classic", 20, 1978
                        )
                    )
                    print(
                        VideoGame("Donkey Kong", "Nintendo", "2D", "Classic", 30, 1981)
                    ...
                    print(
                        VideoGame(
                            "Street Fighter II", "Capcom", "2D", "Classic", 40, 1991
                        )
                    )
                    print(
                        VideoGame(
                    ...
                    print(
                        VideoGame(
                            "Sonic the Hedgehog", "Sega", "2D", "Classic", 35, 1991
                        )
                    )
                    print(
                        VideoGame(
                            "Mortal Kombat", "Midway Games", "2D", "Classic", 40, 1992
                        )
                    )
                    print(
                        VideoGame(
                            "The Legend of Zelda", "Nintendo", "2D", "Classic", 45, 1986
                        )
                    )

                    game_name = input("Enter the name of the game you want to add: ")
                    selected_game = next(
                        (game for game in available_games if game.name == game_name),
                        None,
                    )
                    if selected_game:
